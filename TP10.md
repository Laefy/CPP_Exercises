...
1.  [But de ce TP](#org586368f)
2.  [Les tests pas à pas](#orgd3297b7)
    1.  [Test 01: Image](#org60fdab2)
    2.  [Test 02: Image IO](#org66588f0)
    3.  [Test 03: Procedural Images](#org622beb6)
    4.  [Test 04: Pixels](#orga64451b)
    5.  [Test 05: Blending](#org3a3b01f)
        1.  [color blending](#org9645d70)
        2.  [Luma as alpha mask](#org9141c60)
...
Écrivez une fonction `blend_two_rgba` qui prend deux RGBA et les blend en utilisant mix<sub>color</sub>.
